    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = await UserManager.FindAsync(LogUser, model.Password);
                if (user != null)
                {
        ...
        public ActionResult Manage(ManageMessageId? message, string id)
        {
            ...
            ManageUserViewModel UserModel = new ManageUserViewModel();
            using (var db = new ApplicationDbContext())
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Manage(ManageUserViewModel model, ApplicationUser user, string email)
        {
